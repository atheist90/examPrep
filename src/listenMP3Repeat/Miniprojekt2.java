...
public class Miniprojekt2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("===== Тут делится поезд на две части =====");
        System.out.println(train.toString());
        System.out.println(train2.toString());
        System.out.println("===========================================");
        System.out.println("размер ебаного поезда 1" + train.getSize());
        System.out.println("размер ебаного поезда 2" + train2.getSize());
