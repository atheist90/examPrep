package rekursionEEinstiegInRekursion;
...
//	-------------------- Aufgabe 1 --------------------
    ...
    private static int rekursSummenFormel(int n) {
        ...
        if (n == 0) return 0;
        else return n + rekursSummenFormel(n-1);
...
//	-------------------- Aufgabe 2 --------------------
    ...
    private static int rekursSummenFormel2(int n) {
        // Hier beginnt der zu bearbeitende Bereich.
        if (n == 0) return 0;
        return 2*n + rekursSummenFormel2(n-1);
        // Hier endet der zu bearbeitende Bereich.
    }
...
//	------------------ Main-Methode ------------------
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n---------- Aufgabe 3 ----------");
        System.out.println("Fakultaet fьr n = 2 und n = 6");
